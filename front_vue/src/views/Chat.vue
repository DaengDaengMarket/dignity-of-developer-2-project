<template>
  <div id="chat">
    <chat-sector>
        <div>
            <h2 style="text-align: center;"> <img src="img/km/pawprint.png" style="width:40px;height:40px;" alt="">댕댕톡
            </h2>
        </div>
            ...
            <chat-main>
                <chat-header>
                    <div class="row col-12" style="margin:0; padding:0">
                        ...
                        <div class="row col-5" style="margin-top:10px;">
                            <p style="font-size:11px;">Product Name<br>price: 12000
                                <span style="margin-left:10px;"><img src="img/km/01.jpg" style="width:30px; height:40px"
                                        alt=""></span>
                            </p>

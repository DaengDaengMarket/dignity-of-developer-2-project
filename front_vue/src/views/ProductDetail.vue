    ...
    <div class="container padding-bottom-3x mb-1">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="product-gallery"><span class="product-badge text-danger"></span>
            ...
            <div class="product-carousel owl-carousel gallery-wrapper">
              <div class="gallery-item" data-hash="one"><a href="img/km/01.jpg" data-size="1000x667"><img
                    src="img/km/01.jpg" alt="Product"></a></div>
            </div>
            <ul class="product-thumbnails">
              <li class="active"><a href="#one"><img src="img/km/01.jpg" alt="Product"></a></li>
              <li><a href="#two"><img src="img/km/02.jpg" alt="Product"></a></li>
              <li><a href="#three"><img src="img/km/03.jpg" alt="Product"></a></li>
            </ul>
          </div>
        </div>
        <!-- Product Info-->
        <div class="col-md-6">
          ...
          </div><span class="text-muted align-middle" style="float:right;">&nbsp;&nbsp;카테고리 | 대형 | 강아지 옷
            &nbsp;&nbsp;&nbsp;&nbsp;2분 전<br>
          </span>
          <div class="row">
            <div col-sm-6 style="margin-left:10px;"><img src="img/account/user-ava-md.jpg"
                style="width:50px; height:50px;" alt="Daniel Adams"></div>
            <div col-sm-6 style="vertical-align:middle; margin-top:10px;">Nickname</div>
            <div class="dropdown" style="margin-left:20px;">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                <button class="dropdown-item" type="button">프로필 보기</button>
                <button class="dropdown-item" type="button" data-toggle="modal"
                  data-target="#report-Modal">신고하기</button>
              </div>
            </div>
          </div>
          ...
          <p style="margin-top:50px; "><span style="font-size:30px;">명품 강아지 옷 팝니다</span><span>
              <img src="img/km/view.png" style="width:20px; height:20px; margin-left:100px;" alt="Daniel Adams"></span>
            <span>2</span><span>
              <img src="img/km/heart.png" style="width:20px; height:20px;" alt="Daniel Adams"></span>
            <span>10</span>
          </p>
          ...
          <div class="row">
            <div class="col-12" style="font-size:15px;">
              <ul class="list-group">
                <li class="list-group-item">가격: 15,000원</li>
                <li class="list-group-item">네고여부: 가능</li>
                <li class="list-group-item">거래희망지역: 서울특별시 용산구 청파동</li>
              </ul>
            </div>
          </div>

          <h4 class="text-muted text-normal"><br></h4>
          <h6>귀여운 강아지 옷 팝니다. 강아지가 얼마 전에 사고를 당했는데 정리하려고 싼 값에 올립니다</h6><br><br>


          <hr class="mb-3">
          <div class="d-flex flex-wrap justify-content-between">
            <div class="entry-share mt-2 mb-2"><span class="text-muted">Share:</span>
              <div class="share-links"><a class="social-button shape-circle sb-facebook" href="#" data-toggle="tooltip"
                  ...
                  title="Twitter"><i class="socicon-twitter"></i></a><a class="social-button shape-circle sb-instagram"
                  href="#" data-toggle="tooltip" data-placement="top" title="Instagram"><i
                    class="socicon-instagram"></i></a><a class="social-button shape-circle sb-google-plus" href="#"
                  data-toggle="tooltip" data-placement="top" title="Google +"><i class="socicon-googleplus"></i></a>
              </div>
            </div>
            <div class="sp-buttons mt-2 mb-2">
              ...
              <button class="btn btn-primary" data-toast data-toast-type="success" data-toast-position="topRight"
                ...
                data-toast-message="successfuly added to cart!"><i class="icon-bag"></i> 댕댕톡</button>
            </div>
          </div>
        </div>
      </div>
